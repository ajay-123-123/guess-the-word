...
remove_charAt2 = remove_charAt1(chartAt2, "_");
remove_charAt3 = remove_charAt2(chartAt3, "_");
connsole.log(remove_charAt3);
...
{
    answer_turn = "player2"
    document.getElementById("player_annswer").innerHTML = "answer turn - " + player2_name;
}
else
{
    answer_turn = "player1"
    document.getElementById("player_annswer").innerHTML = "answer turn - " + player1_name;
}
